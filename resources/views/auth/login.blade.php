...
<html lang="en">
  <head>
    ...
    <title>Bank Sampah Login Page</title>
  </head>
  <body>
    ...
    <div class="contents order-2 order-md-1">
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7">
            <h3>Masuk <strong>ke Bank Sampah</strong></h3>
            ...
            <form action="{{url('masuk')}}" method="post">
              ...
              <div class="d-flex mb-5 align-items-center">
                ...
                <span class="ml-auto"><a href="{{url('register')}}" class="forgot-pass">Klik disini untuk mendaftar</a></span> 
              </div>
