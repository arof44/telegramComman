...
<div class="page-wrapper">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-6">
                <div class="text-end upgrade-btn">
                    <a href="#" class="btn btn-primary btn-sm text-white" data-bs-toggle="modal" data-bs-target="#tambahBarang">
                        Tambah Data Barang
                    </a>
                    <!-- <a href="#" class="btn btn-primary btn-sm text-white" data-bs-toggle="modal" data-bs-target="#tambahSatuan">
                        Tambah Data Satuan
                    </a> -->
                </div>
            </div>
                            ...
                            <table class="table" id="example" class="display" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(Auth::check())
                                            <a href="#" class="btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#editBarang{{$item->id}}">
                                                <i class="fa fa-edit" style="color: white;"></i>
                                            </a>
                                            &nbsp;
                                            <a href="#" class="btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteBarang{{$item->id}}">
                ...
                <form action="{{url('barang_insert')}}" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group first">
                            ...
                            <input type="text" class="form-control" placeholder="Barang" id="username" name="nama" required>
                        </div>
                        <div class="form-group first">
    ...
    <div class="modal" id="tambahSatuan">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{url('satuan_insert')}}" method="post">
                    @csrf
                    <!-- Modal Header -->
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="form-group first">
                            <label for="username">Satuan</label>
                            <input type="text" class="form-control" placeholder="Satuan" id="username" name="nama" required>
                        </div>
                    </div>
                    <!-- Modal footer -->
                    <div class="modal-footer">
