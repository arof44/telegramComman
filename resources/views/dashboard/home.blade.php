    ...
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            <div class="col-6">
                ...
                <h1 class="mb-0 fw-bold">Dashboard Kios Sahabat Tani</h1>
            </div>
            <!-- <div class="col-6">
            ...
            data: [{
                    ...
                    dataPoints: [
                        ...
                        <?php foreach ($dataBulan as $key => $dt) { ?>
                            ...
                            {
                                x: new Date(<?php echo $dataBulan[$key]['Y'] ?>, <?php echo $dataBulan[$key]['m'] ?>, <?php echo $dataBulan[$key]['d'] ?>),
                                y: <?php echo $dataBulan[$key]['masuk'] ?>
                            },
                ...
                },
                {
                    ...
                    dataPoints: [
                        <?php foreach ($dataBulan as $key => $dt) { ?>
                            ...
                            {
                                x: new Date(<?php echo $dataBulan[$key]['Y'] ?>, <?php echo $dataBulan[$key]['m'] ?>, <?php echo $dataBulan[$key]['d'] ?>),
                                y: <?php echo $dataBulan[$key]['keluar'] ?>
                            },
